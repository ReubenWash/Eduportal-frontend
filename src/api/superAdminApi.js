...
// NOTE: there is no backend endpoint yet to list past broadcasts
// (the Announcement records created by mass-broadcast have no GET route).
// This will 404 until that's added on the backend.
...
export const getEmailTemplates = async () => {
  const res = await api.get('/admin/cms/email-templates');
  return unwrapList(res.data);
};
